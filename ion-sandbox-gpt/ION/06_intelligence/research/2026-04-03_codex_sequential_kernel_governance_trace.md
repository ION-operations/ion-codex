...
objective: ratify the continuity floor
required_surfaces_ok: True

1. codex — classify the problem and prepare the bounded convergence object
   ...
   - codex.directive.1: ION/01_doctrine/SOVEREIGN_CONSTITUTION.md
...
2. vizier — perform the primary architecture or governance pass
   ...
   - vizier.directive.1: ION/01_doctrine/SOVEREIGN_CONSTITUTION.md
...
3. vice — apply conjugate daimon pressure to preserve future answerability
   ...
   - vice.directive.1: ION/01_doctrine/SOVEREIGN_CONSTITUTION.md
...
4. nemesis — audit the consolidated set before closure
...
5. relay — package the result for the Sovereign or wider field
   ...
   - relay.directive.1: ION/01_doctrine/SOVEREIGN_CONSTITUTION.md
