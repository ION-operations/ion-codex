...
class MissionAdvisoryProfile(StrEnum):
    PIPELINE = "pipeline"
    DAG = "dag"
    MESH = "mesh"
    CRUCIBLE = "crucible"
...
class MissionAdvisoryPlannerManifestMaintenanceDispositionAction(StrEnum):
...
class OpenQuestion(KernelRecord):
    ...
    needed_from_raw: str | None = None
    needed_from_resolution_note: str | None = None
...
class QuestionAnswerRecord(KernelRecord):
    ...
    resolution: str
    resolution_evidence: tuple[str, ...] = ()
    answered_by_raw: str | None = None
    answered_by_resolution_note: str | None = None
...
@dataclass(frozen=True)
class RootAuthorityBundleExerciseReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    carrier_key: str
    ...
    shared_entry: str | None = None
    forward_path_anchor: str | None = None
    carrier_entry_path: str | None = None
...
@dataclass(frozen=True)
class RootAuthorityBundleExternalReturnReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    carrier_key: str
    external_return_status: str
    reported_from: str
    source_chassis: str
    governing_packet: str
    governing_packet_matches_expected: bool
    workspace_snapshot: str
    target_owner: str
    targets: tuple[str, ...]
    source_path: str
    source_relative_path: str | None = None
    archived_packet_path: str | None = None
    archived_packet_relative_path: str | None = None
...
@dataclass(frozen=True)
class ExecutorWorkLifecycleBindingReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    scope_type: str
    ...
    source_schedule_dispatch_reconciliation_receipt_id: str
    work_unit_id: str
    lifecycle_action: str = "ENTER_EXECUTION"
    source_executor_work_lifecycle_binding_receipt_id: str | None = None
    source_schedule_completion_release_receipt_id: str | None = None
    terminal_commit_delta_id: str | None = None
    terminal_commit_delta_status: CommitDeltaStatus | None = None
...
@dataclass(frozen=True)
class MissionAdvisoryRoutingReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    mission_text: str
    recommended_profile: MissionAdvisoryProfile
    confidence: float
    reason: str
...
@dataclass(frozen=True)
class MissionAdvisoryManifestRouteBindingReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    manifest_id: str
    ...
    owner_scope_id: str
    source_mission_advisory_routing_receipt_id: str
    recommended_profile: MissionAdvisoryProfile
    advisory_only: bool = True
    binding_action: str = "ANNOTATE_ROUTE_STATE"
    route_confidence_before: str | None = None
    route_confidence_after: str | None = None
    recommended_action_before: str | None = None
    recommended_action_after: str | None = None
    next_route_proposal_before: str | None = None
    next_route_proposal_after: str | None = None
    reasons_added: tuple[str, ...] = ()
    evidence_ref_added: str | None = None
    preserved_existing_route_proposal: bool = False
    warnings: tuple[str, ...] = ()


@dataclass(frozen=True)
class MissionAdvisoryHorizonBindingReceipt(KernelRecord):
    receipt_id: str
    created_at: str
    policy_id: str
    manifest_id: str
    owner_scope_type: str
    owner_scope_id: str
    source_mission_advisory_manifest_route_binding_receipt_id: str
    source_mission_advisory_routing_receipt_id: str
    recommended_profile: MissionAdvisoryProfile
    advisory_only: bool = True
    binding_action: str = "ANNOTATE_HORIZON"
    horizon_id: str = ""
    horizon_layer: HorizonLayer = HorizonLayer.NEAR
    created_new_horizon: bool = False
    advisory_item_id: str | None = None
    governing_ref_added: str | None = None
    preserved_existing_work_items: bool = False
    next_window_hint: str | None = None
    warnings: tuple[str, ...] = ()


@dataclass(frozen=True)
class MissionAdvisoryPlannerManifestMaintenanceReceipt(KernelRecord):
    receipt_id: str
    generated_at: str
    policy_id: str
    source_mission_advisory_horizon_binding_receipt_id: str
    horizon_id: str
    horizon_layer: HorizonLayer
    owner_scope_type: str
    owner_scope_id: str
    recommended_profile: MissionAdvisoryProfile
    suggested_manifest_ids: tuple[str, ...] = ()
    suggested_target_statuses: tuple[PlannerManifestStatus, ...] = ()
    reasons: tuple[str, ...] = ()
    candidate_count: int = 0
    advisory_only: bool = True
    warnings: tuple[str, ...] = ()
...
@dataclass(frozen=True)
class MissionAdvisoryPlannerManifestMaintenanceDispositionReceipt(KernelRecord):
    receipt_id: str
    generated_at: str
    policy_id: str
    source_mission_advisory_planner_manifest_maintenance_receipt_id: str
    source_mission_advisory_horizon_binding_receipt_id: str
    horizon_id: str
    horizon_layer: HorizonLayer
    owner_scope_type: str
    owner_scope_id: str
    recommended_profile: MissionAdvisoryProfile
    action: MissionAdvisoryPlannerManifestMaintenanceDispositionAction
    actor: str
    reason: str
...
@dataclass(frozen=True)
class MissionAdvisoryPlannerManifestMaintenanceResolutionReceipt(KernelRecord):
    receipt_id: str
    generated_at: str
    policy_id: str
    source_mission_advisory_planner_manifest_maintenance_disposition_receipt_id: str
    source_mission_advisory_planner_manifest_maintenance_receipt_id: str
    source_mission_advisory_horizon_binding_receipt_id: str
    horizon_id: str
    horizon_layer: HorizonLayer
    ...
    owner_scope_id: str
    recommended_profile: MissionAdvisoryProfile
    disposition_action: MissionAdvisoryPlannerManifestMaintenanceDispositionAction
    actor: str
    resolution_note: str
    linked_open_question_id: str | None = None
    linked_branch_control_receipt_id: str | None = None
    linked_parent_work_unit_id: str | None = None
    escalate_review: bool = False
    branch_control_captured: bool = False
    advisory_only: bool = True
    warnings: tuple[str, ...] = ()
