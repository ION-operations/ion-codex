...
from .model import AutomationStateRecord, BranchClaimReceipt, BranchControlReceipt, BranchHorizonSyncReceipt, BranchMergeProposal, BranchRescheduleReceipt, BranchSettlementReceipt, CommitDelta, ContextPackage, ContextPerfectContinuationReceipt, ExecutorCapability, ExecutorWorkLifecycleBindingReceipt, HorizonEnactmentReceipt, HorizonRecord, KernelRecord, ManifestRouteStateRecord, ManualAutomationEquivalenceReceipt, MissionAdvisoryManifestRouteBindingReceipt, MissionAdvisoryHorizonBindingReceipt, MissionAdvisoryPlannerManifestMaintenanceReceipt, MissionAdvisoryPlannerManifestMaintenanceDispositionReceipt, MissionAdvisoryPlannerManifestMaintenanceResolutionReceipt, MissionAdvisoryRoutingReceipt, OpenQuestion, PlannerManifest, PlannerManifestSweepAggregateRecord, PlannerManifestSweepReceipt, QuestionAnswerRecord, ReviewerAnswerQueueProjectionRecord, ReviewerQueueRefreshReceipt, RootAuthorityBundleExerciseReceipt, RootAuthorityBundleExternalReturnReceipt, ScheduleCompletionReleaseReceipt, ScheduleControlReceipt, ScheduleDispatchReconciliationReceipt, ScheduleExecutorStartPacketMaterializationReceipt, ScheduleLineageArchiveReceipt, ScheduleLineageReplayReceipt, ScheduleResumeProjectionReceipt, ScheduleResumeBundleMaterializationReceipt, ScheduleTakeoverEntryActivationReceipt, ScheduleActivationHandoffCapsuleReceipt, ScheduleHandoffEntryRehearsalReceipt, ScheduleReceipt, ScheduleSettlementReceipt, TakeoverAssessmentReceipt, WorkUnit
...
class KernelStore:
    ...
    _SPECS: tuple[RecordSpec, ...] = (
        ...
        RecordSpec(
            record_type="root_authority_bundle_exercise_receipt",
            directory="root_authority_bundle_exercise_receipts",
            cls=RootAuthorityBundleExerciseReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="root_authority_bundle_external_return_receipt",
            directory="root_authority_bundle_external_return_receipts",
            cls=RootAuthorityBundleExternalReturnReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
        ...
        RecordSpec(
            record_type="mission_advisory_routing_receipt",
            directory="mission_advisory_routing_receipts",
            cls=MissionAdvisoryRoutingReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="mission_advisory_manifest_route_binding_receipt",
            directory="mission_advisory_manifest_route_binding_receipts",
            cls=MissionAdvisoryManifestRouteBindingReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="mission_advisory_horizon_binding_receipt",
            directory="mission_advisory_horizon_binding_receipts",
            cls=MissionAdvisoryHorizonBindingReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="mission_advisory_planner_manifest_maintenance_receipt",
            directory="mission_advisory_planner_manifest_maintenance_receipts",
            cls=MissionAdvisoryPlannerManifestMaintenanceReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="mission_advisory_planner_manifest_maintenance_disposition_receipt",
            directory="mission_advisory_planner_manifest_maintenance_disposition_receipts",
            cls=MissionAdvisoryPlannerManifestMaintenanceDispositionReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
            record_type="mission_advisory_planner_manifest_maintenance_resolution_receipt",
            directory="mission_advisory_planner_manifest_maintenance_resolution_receipts",
            cls=MissionAdvisoryPlannerManifestMaintenanceResolutionReceipt,
            id_field="receipt_id",
        ),
        RecordSpec(
        ...
        RecordSpec(
            record_type="executor_work_lifecycle_binding_receipt",
            directory="executor_work_lifecycle_binding_receipts",
            cls=ExecutorWorkLifecycleBindingReceipt,
            id_field="receipt_id",
        ),
    )
