# COMPILED VESTIGE CONTEXT BUNDLE
...
- role: `VESTIGE`
- context_package_path: `ION/05_context/current/execution_cycles/2026-05-08T034831Z0000_carrier_continue_mount_ion_and_start_the_self_knowledge_domain_state_workpack_recover_existing_se/02_vestige_cursor_task_prompt.md`
- context_load_receipt_path: `ION/05_context/current/execution_cycles/2026-05-08T034831Z0000_carrier_continue_mount_ion_and_start_the_self_knowledge_domain_state_workpack_recover_existing_se/02_vestige_context_load_receipt.json`
...
# ION Carrier Role ContextPackage — VESTIGE
...
- authority_level: `PROVENANCE_AND_RECOVERY_REVIEW_BOUNDED`
- production_authority: `false`
- live_execution_authority: `false`
- workstream: `archaeology`
- session_packet_path: `ION/05_context/current/execution_cycles/2026-05-08T034831Z0000_carrier_continue_mount_ion_and_start_the_self_knowledge_domain_state_workpack_recover_existing_se/02_vestige_session.md`
- proposal_status: `PENDING_STEWARD_REVIEW`

## Mission

Mount ION and start the self-knowledge domain-state workpack: recover existing self-knowledge organs, classify/rank them, seed routable self-knowledge domain state, and export candidate bundle without production/live authority.
