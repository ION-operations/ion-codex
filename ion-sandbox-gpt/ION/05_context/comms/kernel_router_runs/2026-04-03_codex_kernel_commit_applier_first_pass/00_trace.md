...
1. codex — classify the task and prepare the scoped implementation route
   ...
   - codex.directive.1: ION/04_packages/kernel/validation.py
   - codex.directive.2: ION/06_intelligence/specs/T01_TransitionSchema.spec.md
   - codex.directive.3: ION/06_intelligence/specs/T04_CommitDeltaSchema.spec.md
...
3. mason — execute the bounded implementation slice
   ...
   - mason.directive.3: ION/06_intelligence/specs/T04_CommitDeltaSchema.spec.md
...
4. vice — apply risk pressure if the slice affects continuity or governance
   ...
   - vice.directive.1: ION/04_packages/kernel/validation.py
   - vice.directive.2: ION/06_intelligence/specs/T01_TransitionSchema.spec.md
   - vice.directive.3: ION/06_intelligence/specs/T04_CommitDeltaSchema.spec.md
