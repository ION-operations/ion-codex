...
1. codex — classify the task and prepare the scoped implementation route
   ...
   - codex.directive.3: ION/06_intelligence/specs/T07_SignalSchema.spec.md
...
2. vizier — define scope, dependencies, and required review posture
   ...
   - vizier.directive.3: ION/06_intelligence/specs/T07_SignalSchema.spec.md
...
4. vice — apply risk pressure if the slice affects continuity or governance
   ...
   - vice.directive.3: ION/06_intelligence/specs/T07_SignalSchema.spec.md
