# Cost Quality Margin Routing Protocol
...
Defines cost-quality and margin-aware route selection. V56 avoids live pricing claims by marking pricing as placeholder/registry data requiring update before live use.
