...
2. vizier — define scope, dependencies, and required review posture
   ...
   - vizier.directive.1: ION/05_context/inbox/codex_context_compiler_first_pass_2026-04-03.task.md
...
3. mason — execute the bounded implementation slice
   ...
   - mason.directive.1: ION/05_context/inbox/codex_context_compiler_first_pass_2026-04-03.task.md
