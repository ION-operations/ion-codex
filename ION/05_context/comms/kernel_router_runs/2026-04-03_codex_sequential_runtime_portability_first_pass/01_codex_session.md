...
- codex.directive.1: ION/05_context/inbox/codex_sequential_runtime_portability_first_pass_2026-04-03.task.md
...
- codex.extra.1: ION/04_packages/kernel/sequential_kernel.py [optional]
- codex.extra.2: ION/tests/test_sequential_kernel.py [optional]
- codex.extra.3: ION/06_intelligence/research/2026-04-03_codex_response_to_external_canonicalization_memo.md [optional]
- codex.extra.4: ION/07_templates/bindings/CODEX__CODE.md [optional]
...
- status: COMPLETE
- operator: Codex
- summary: Removed live production-root hardcoding from the sequential runtime shell while preserving current behavior.
- artifacts:
