...
1. codex — classify the task and prepare the scoped implementation route
   ...
   - codex.directive.1: ION/05_context/inbox/codex_kernel_graph_first_pass_2026-04-03.task.md
...
3. mason — execute the bounded implementation slice
   ...
   - mason.directive.1: ION/05_context/inbox/codex_kernel_graph_first_pass_2026-04-03.task.md
...
4. vice — apply risk pressure if the slice affects continuity or governance
   ...
   - vice.directive.1: ION/05_context/inbox/codex_kernel_graph_first_pass_2026-04-03.task.md
