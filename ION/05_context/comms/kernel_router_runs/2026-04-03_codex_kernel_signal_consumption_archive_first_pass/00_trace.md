...
2. vizier — define scope, dependencies, and required review posture
   ...
   - vizier.directive.1: ION/04_packages/kernel/receipts.py
   - vizier.directive.2: ION/06_intelligence/specs/T07_SignalSchema.spec.md
   - vizier.directive.3: ION/06_intelligence/research/2026-04-03_codex_kernel_validation_receipt_signal_first_pass.md
...
3. mason — execute the bounded implementation slice
   ...
   - mason.directive.1: ION/04_packages/kernel/receipts.py
   - mason.directive.2: ION/06_intelligence/specs/T07_SignalSchema.spec.md
   - mason.directive.3: ION/06_intelligence/research/2026-04-03_codex_kernel_validation_receipt_signal_first_pass.md
...
4. vice — apply risk pressure if the slice affects continuity or governance
   ...
   - vice.directive.1: ION/04_packages/kernel/receipts.py
   - vice.directive.2: ION/06_intelligence/specs/T07_SignalSchema.spec.md
   - vice.directive.3: ION/06_intelligence/research/2026-04-03_codex_kernel_validation_receipt_signal_first_pass.md
