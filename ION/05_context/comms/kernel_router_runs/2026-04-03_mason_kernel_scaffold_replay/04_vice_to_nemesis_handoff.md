...
- Session artifact: ION/05_context/comms/kernel_router_runs/2026-04-03_mason_kernel_scaffold_replay/04_vice_session.md

## What remains

- Perform the actual `nemesis` pass for `replay the mason scaffold packet`.
- Decide whether any generated scaffold must be tightened before real execution.

## Exact artifacts to read

- ION/05_context/comms/kernel_router_runs/2026-04-03_mason_kernel_scaffold_replay/04_vice_session.md
- ION/05_context/comms/kernel_router_runs/2026-04-03_mason_kernel_scaffold_replay/05_nemesis_session.md
