...
- Session artifact: ION/05_context/comms/kernel_router_runs/2026-04-03_mason_kernel_scaffold_replay/01_codex_session.md

## What remains

- Perform the actual `vizier` pass for `replay the mason scaffold packet`.
...
- ION/05_context/comms/kernel_router_runs/2026-04-03_mason_kernel_scaffold_replay/02_vizier_session.md
