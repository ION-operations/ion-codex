...
1. codex — classify the task and prepare the scoped implementation route
   ...
   - codex.directive.1: ION/04_packages/kernel/commit.py
   - codex.directive.2: ION/06_intelligence/specs/T04_CommitDeltaSchema.spec.md
   - codex.directive.3: ION/06_intelligence/specs/T05_OpenQuestionSchema.spec.md
...
5. nemesis — audit or verify when the slice becomes release-sensitive
   ...
   - nemesis.directive.1: ION/04_packages/kernel/commit.py
   - nemesis.directive.2: ION/06_intelligence/specs/T04_CommitDeltaSchema.spec.md
   - nemesis.directive.3: ION/06_intelligence/specs/T05_OpenQuestionSchema.spec.md
