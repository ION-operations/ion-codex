...
2. vizier — define scope, dependencies, and required review posture
   ...
   - vizier.directive.1: ION/01_doctrine/CANONICAL_WORKFLOW.md
   - vizier.directive.2: ION/AGENT_CONTRACT.md
   - vizier.directive.3: ION/SYSTEM_MAP.md
...
3. mason — execute the bounded implementation slice
   ...
   - mason.directive.1: ION/01_doctrine/CANONICAL_WORKFLOW.md
   - mason.directive.2: ION/AGENT_CONTRACT.md
   - mason.directive.3: ION/SYSTEM_MAP.md
...
4. vice — apply risk pressure if the slice affects continuity or governance
   ...
   - vice.directive.1: ION/01_doctrine/CANONICAL_WORKFLOW.md
   - vice.directive.2: ION/AGENT_CONTRACT.md
   - vice.directive.3: ION/SYSTEM_MAP.md
...
5. nemesis — audit or verify when the slice becomes release-sensitive
   ...
   - nemesis.directive.1: ION/01_doctrine/CANONICAL_WORKFLOW.md
   - nemesis.directive.2: ION/AGENT_CONTRACT.md
   - nemesis.directive.3: ION/SYSTEM_MAP.md
