...
1. steward — classify the task and prepare the scoped implementation route
   ...
   - steward.private_mini: ION/agents/steward/MINI.md [missing]
   - steward.private_capsule: ION/agents/steward/CAPSULE.md [missing]
...
2. vizier — define scope, dependencies, and required review posture
   ...
   - vizier.private_mini: ION/agents/vizier/MINI.md [missing]
   - vizier.private_capsule: ION/agents/vizier/CAPSULE.md [missing]
...
3. mason — execute the bounded implementation slice
   ...
   - mason.private_mini: ION/agents/mason/MINI.md [missing]
   - mason.private_capsule: ION/agents/mason/CAPSULE.md [missing]
...
5. nemesis — audit or verify when the slice becomes release-sensitive
   ...
   - nemesis.private_mini: ION/agents/nemesis/MINI.md [missing]
