...
source_task: carrier_continue:reconcile chatgpt browser mcp connector transport truth, health check, carrier-specific onboarding tick, and human trial instructions
next_role: nemesis
---
