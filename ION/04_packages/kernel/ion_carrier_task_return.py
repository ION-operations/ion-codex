"""Record and proof-gate Cursor Task returns for the ION carrier loop.
...
This module does not perform live Cursor automation. It gives the carrier a
deterministic file-backed intake transaction for returns that Cursor already
received from Task workers.
"""
...
def record_task_return(
    ...
    *,
    ...
    """Evaluate and record one Cursor Task return for a spawned role row."""
