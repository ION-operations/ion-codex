# Cross Model Audit And Consensus Protocol
...
Defines consensus-required classes and future multi-model audit receipts. V56 only records policy classes; no model calls occur.
