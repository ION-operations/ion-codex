# Api Rate Governor And Provider Limit Protocol
...
Defines provider capacity and rate-governor policy surfaces. V56 records registry skeletons; V58 should implement queue/reroute/throttle/block decisions.
