# Model Routing And Provider Economics Protocol
...
Defines how ION will select provider/model routes from work class, capability, cost, latency, privacy, risk, and current capacity. V56 installs registries and policies only; V57 should implement deterministic router logic.
